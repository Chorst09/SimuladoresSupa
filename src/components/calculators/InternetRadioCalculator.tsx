...
const InternetRadioCalculator: React.FC<InternetRadioCalculatorProps> = ({ onBackToDashboard }) => {
    ...
    useEffect(() => {
        console.log('🔄 useEffect EXECUTADO - currentProposal:', currentProposal?.id);
    ...
    const handleSave = async (proposalId?: string, saveAsNewVersion: boolean = false) => {
        ...
        try {
            ...
            if (saveAsNewVersion === false && currentProposal?.id) {
                ...
                console.log('🔄 Atualizando proposta Internet Rádio existente:', currentProposal.id);
                ...
                // CRIAR NOVA VERSÃO
                console.log('📝 Criando nova versão da proposta Internet Rádio');
                console.log('🔍 Descontos atuais:', {
                    applySalespersonDiscount,
                    appliedDirectorDiscountPercentage
                });
                
                if (!currentProposal.baseId && !(currentProposal as any).base_id) {
                                                        ...
                                                        {isExistingClient && previousMonthlyFee > 0 && (
                                                            <>
                                                                ...
                                                                <div className={`flex justify-between p-3 rounded-lg ${
                                                                    finalTotalMonthly - previousMonthlyFee >= 0
                                                                    ...
                                                                    <span className={`font-bold text-lg ${
                                                                        ...
                                                                        {finalTotalMonthly - previousMonthlyFee >= 0 ? '+' : ''}
                                                                        {formatCurrency(finalTotalMonthly - previousMonthlyFee)}
                                                                    </span>
                                                                </div>
