        ...
        try {
            ...
            if (response.ok) {
                ...
                if (result.success && result.data && result.data.proposals) {
                    ...
                    console.log(`📊 Total de propostas INTERNET_MAN_FIBRA carregadas: ${manProposals.length}`);
    ...
    const saveProposal = async () => {
        ...
        try {
            ...
            if (currentProposal?.id) {
                ...
                const baseId = generateNextProposalId(proposalsWithBaseId, 'INTERNET_MAN_FIBRA', proposalVersion);
                console.log('🆔 ID gerado para nova proposta MAN Fibra:', baseId);
