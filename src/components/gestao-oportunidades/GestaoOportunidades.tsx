        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-800/50 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-gray-400">
                  <h4 className="font-semibold text-sm text-gray-800 dark:text-gray-200">
                    Campanha Marketing
                  </h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
