            ...
            <Tabs defaultValue="calculator" className="w-full">
                ...
                <TabsContent value="dre">
                    {(() => {
                        ...
                        const impostosSobreReceita = receitaOperacionalBruta * (taxRates.simplesNacional / 100);
                        ...
                        // Custo/Desp
                        const custoDesp = receitaOperacionalBruta * (taxRates.custoDesp / 100);
                        
                        // Lucro/Prejuízo Operacional
                        const lucroOperacional = receitaOperacionalLiquida - despesasComissoes - estimatedOperationalCosts - custoDesp;
